...
import { IResultState, IStateType } from "../../store/models/root.interface";
import ProductList from "../Result/ResultList";
...
const Home: React.FC = () => {
  ...
  const totalProductAmount: number = results.results.reduce((prev, next) => prev + (next.amount || 0), 0);
